 ...
 *  
 * @property {string} venueSlug - venue url slug  
 * @property {number} cartValue - cart amount - non negative integer due to lowest denomination of currency.  
 * @property {number} userLatitude - user latitude location in range [-90,90]  
 * @property {number} userLongitude - user longitude location in range [-180,180) 
 */
