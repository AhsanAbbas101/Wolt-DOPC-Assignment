 ...
 * @returns 
 * totalPrice (integer): The calculated total price.  
 * smallOrderSurcharge (integer): The calculated small order surcharge  
 * cartValue (integer): The cart value. This is the same as what was got as query parameter.  
 * deliveryFee (integer): The calculated delivery fee  
 * deliveryDistance (integer): The calculated delivery distance in meters
 */
